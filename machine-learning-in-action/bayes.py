...
###################################
#Covert vocabulary table into vector
def loadDataSet():
...
def trainNB0(trainMatrix, trainCategory):
    ...
    #pAbusive = sumOfClass / float(numTrainDocs)
...
#---------------------------------
# Example for getting personal ad
#---------------------------------
